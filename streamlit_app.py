...
with col1:
    ...
    if editorial_role == "Fact-Checker Focus":
        st.markdown('<div class="fact-check-warning">Please note: AI fact-checking is often unreliable and requires human verification!</div>', unsafe_allow_html=True)
...
if st.session_state.has_analysis:
    ...
    <strong>⚠️ Using AI Editorial Feedback Responsibly - Enhanced Transparency</strong><br>
    ...
    with tab2:
        ...
        with col3:
            ...
            st.markdown("⚠️ **Note:** AI fact-checkers can make significant errors. Always verify independently.")
